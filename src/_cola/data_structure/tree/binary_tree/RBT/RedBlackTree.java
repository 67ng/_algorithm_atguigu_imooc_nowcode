package _cola.data_structure.tree.binary_tree.RBT;
 ...
 * Description:红黑树
 *
 * Red-Black tree_dp implementation. From Introduction to Algorithms 3rd edition.
 *
 * @author Ignas Lelys
 * @created May 6, 2011
 *
...
public class RedBlackTree extends AbstractSelfBalancingBinarySearchTree {
    ...
    /**
     * Slightly modified delete routine for red-black tree_dp.
     *
     * {@inheritDoc}
     */
    @Override
    ...
    /**
     * Restores Red-Black tree_dp properties after delete if needed.
     */
    ...
    /**
     * Restores Red-Black tree_dp properties after insert if needed. Insert can
