package _cola.data_structure.tree.binary_tree.AVL;


import _cola.data_structure.tree.binary_tree.BST.AbstractSelfBalancingBinarySearchTree;
 ...
 * 介绍
 ...
 4，介绍删除节点时的调整细节
 * <p>
 * AVL tree_dp implementation.
 * <p>
 * In computer science, an AVL tree_dp is a self-balancing binary search tree_dp, and
 * it was the first such data structure to be invented.[1] In an AVL tree_dp, the
 ...
 * cases, where n is the number of nodes in the tree_dp prior to the operation.
 * Insertions and deletions may require the tree_dp to be rebalanced by one or more
 * tree_dp rotations.
 *
 * @author Ignas Lelys
 * @created Jun 28, 2011
 */
public class AVLTree2 extends AbstractSelfBalancingBinarySearchTree {

    /**
     * @seetrees.AbstractBinarySearchTree#insert(int)
     * <p>
     * AVL tree_dp insert method also balances tree_dp if needed. Additional
     * height parameter on node is used to track if one subtree is higher
     * than other by more than one, if so AVL tree_dp rotations is performed
     * to regain balance of the tree_dp.
     */
    @Override
    ...
    /**
     * @seetrees.AbstractBinarySearchTree#delete(int)
     */
    @Override
    ...
    /**
     * @seetrees.AbstractBinarySearchTree#createNode(int, trees.AbstractBinarySearchTree.Node, trees.AbstractBinarySearchTree.Node, trees.AbstractBinarySearchTree.Node)
     */
    @Override
    ...
    /**
     * Node of AVL tree_dp has height and balance additional properties. If balance
