package simple_fun.data_structure.tree.binary_tree.BST;

/**
 * Description:搜索二叉树
 * <p>
 * Abstract binary search tree_dp implementation. Its basically fully implemented
 * binary search tree_dp, just template method is provided for creating Node (other
 * trees can have slightly different nodes with more info). This way some code
 * from standart binary search tree_dp can be reused for other kinds of binary
 * trees.
 *
 * @author Ignas Lelys
 * @created Jun 29, 2011
...
public class AbstractBinarySearchTree {
    ...
    /**
     * Root node where whole tree_dp starts.
     */
    public Node root;
    ...
    /**
     * Put one node from tree_dp (newNode) to the place of another (nodeToReplace).
     *
     * @param nodeToReplace Node which is replaced by newNode and removed from tree_dp.
    ...
    /**
     * @param element
     * @return true if tree_dp contains element.
     */
    ...
    /**
     * @return Minimum element in tree_dp.
     */
    ...
    /**
     * @return Maximum element in tree_dp.
     */
    ...
    /**
     * @return Number of elements in the tree_dp.
     */
    public int getSize() {
        return size;
    }
