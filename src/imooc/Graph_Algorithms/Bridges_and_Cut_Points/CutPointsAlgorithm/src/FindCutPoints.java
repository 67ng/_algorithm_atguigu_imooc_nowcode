package imooc.Graph_Algorithms.Bridges_and_Cut_Points.CutPointsAlgorithm.src;
...
public class FindCutPoints {
    ...
    public static void main(String[] args) {
        ...
        Graph g = new Graph("C:\\Users\\daito\\ideaproject\\justforfun\\src\\imooc\\Graph_Algorithms\\Bridges_and_Cut_Points\\CutPointsAlgorithm\\g.txt");
        FindCutPoints fc = new FindCutPoints(g);
        System.out.println("Cut Points in g : " + fc.result());

        Graph g2 = new Graph("C:\\Users\\daito\\ideaproject\\justforfun\\src\\imooc\\Graph_Algorithms\\Bridges_and_Cut_Points\\CutPointsAlgorithm\\g2.txt");
        FindCutPoints fc2 = new FindCutPoints(g2);
        System.out.println("Cut Points in g2 : " + fc2.result());

        Graph tree = new Graph("C:\\Users\\daito\\ideaproject\\justforfun\\src\\imooc\\Graph_Algorithms\\Bridges_and_Cut_Points\\CutPointsAlgorithm\\tree.txt");
