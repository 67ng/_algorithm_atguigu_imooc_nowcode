package imooc.Graph_Algorithms.Bridges_and_Cut_Points.BridgesAlgorithm.src;
...
public class FindBridges {
    ...
    public static void main(String[] args) {
        ...
        Graph g = new Graph("C:\\Users\\daito\\ideaproject\\justforfun\\src\\imooc\\Graph_Algorithms\\Bridges_and_Cut_Points\\BridgesAlgorithm\\g.txt");
        FindBridges fb = new FindBridges(g);
        System.out.println("Bridges in g : " + fb.result());

        Graph g2 = new Graph("C:\\Users\\daito\\ideaproject\\justforfun\\src\\imooc\\Graph_Algorithms\\Bridges_and_Cut_Points\\BridgesAlgorithm\\g2.txt");
        FindBridges fb2 = new FindBridges(g2);
        System.out.println("Bridges in g2 : " + fb2.result());

        Graph g3 = new Graph("C:\\Users\\daito\\ideaproject\\justforfun\\src\\imooc\\Graph_Algorithms\\Bridges_and_Cut_Points\\BridgesAlgorithm\\g3.txt");
        FindBridges fb3 = new FindBridges(g3);
        System.out.println("Bridges in g3 : " + fb3.result());

        Graph tree = new Graph("C:\\Users\\daito\\ideaproject\\justforfun\\src\\imooc\\Graph_Algorithms\\Bridges_and_Cut_Points\\BridgesAlgorithm\\tree.txt");
