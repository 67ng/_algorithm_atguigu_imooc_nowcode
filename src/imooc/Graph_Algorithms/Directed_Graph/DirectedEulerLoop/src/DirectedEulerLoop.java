package imooc.Graph_Algorithms.Directed_Graph.DirectedEulerLoop.src;
...
public class DirectedEulerLoop {
    ...
    public static void main(String[] args) {
        ...
        Graph g = new Graph("C:\\Users\\daito\\ideaproject\\justforfun\\src\\imooc\\Graph_Algorithms\\Directed_Graph\\DirectedEulerLoop\\ug.txt", true);
        DirectedEulerLoop el = new DirectedEulerLoop(g);
        System.out.println(el.result());

        Graph g2 = new Graph("C:\\Users\\daito\\ideaproject\\justforfun\\src\\imooc\\Graph_Algorithms\\Directed_Graph\\DirectedEulerLoop\\ug2.txt", true);
