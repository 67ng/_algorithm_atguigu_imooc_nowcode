package _courses.nowcode.zuoshen.datastructure.linkedlist;

import java.util.Random;

/**
 * Description:Java API中提供了支持并发操作的跳跃表ConcurrentSkipListSet和ConcurrentSkipListMap
 *
 *有以下结论：
 * 1.有序的情况下：
...
public class SkipListDemo2 {
     ...
     */
    public static class SkipListNode<T> {//节点类
        public int key;
        public T value;
     ...
     * 参考：http://www.acmerblog.com/skip-list-impl-java-5773.html
     */
    public static class SkipList<T> {//跳表实现
