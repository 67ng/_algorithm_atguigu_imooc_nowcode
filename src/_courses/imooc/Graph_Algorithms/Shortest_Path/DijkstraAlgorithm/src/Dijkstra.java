package _courses.imooc.Graph_Algorithms.Shortest_Path.DijkstraAlgorithm.src;
...
public class Dijkstra {
    ...
    static public void main(String[] args) {
        ...
        WeightedGraph g = new WeightedGraph("C:\\Users\\daito\\ideaproject\\justforfun\\src\\_courses.imooc\\Graph_Algorithms\\Shortest_Path\\DijkstraAlgorithm\\g.txt");
        Dijkstra dij = new Dijkstra(g, 2);
        for (int v = 0; v < g.V(); v++)
