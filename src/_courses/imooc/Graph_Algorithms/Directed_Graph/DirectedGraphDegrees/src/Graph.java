package _courses.imooc.Graph_Algorithms.Directed_Graph.DirectedGraphDegrees.src;
...
public class Graph implements Cloneable {
    ...
    private int[] indegrees, outdegrees;//入度、出度
    ...
    public int degree(int v) {//无向图的度数
        if (directed)
    ...
    public static void main(String[] args) {
        ...
        Graph g = new Graph("C:\\Users\\daito\\ideaproject\\justforfun\\src\\_courses.imooc\\Graph_Algorithms\\Directed_Graph\\DirectedGraphDegrees\\ug.txt", true);
        System.out.print(g);
