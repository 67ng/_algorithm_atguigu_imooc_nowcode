package _courses.imooc.Graph_Algorithms.Euler_Loop_and_Euler_Path.HierholzerAlgorithm.src;
...
public class EulerLoop {
    ...
    public static void main(String[] args) {
        ...
        Graph g = new Graph("C:\\Users\\daito\\ideaproject\\justforfun\\src\\_courses.imooc\\Graph_Algorithms\\Euler_Loop_and_Euler_Path\\HierholzerAlgorithm\\g.txt");
        EulerLoop el = new EulerLoop(g);
        System.out.println(el.result());

        Graph g2 = new Graph("C:\\Users\\daito\\ideaproject\\justforfun\\src\\_courses.imooc\\Graph_Algorithms\\Euler_Loop_and_Euler_Path\\HierholzerAlgorithm\\g2.txt");
