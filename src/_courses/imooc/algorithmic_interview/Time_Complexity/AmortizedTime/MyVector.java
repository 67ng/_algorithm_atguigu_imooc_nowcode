package _courses.imooc.algorithmic_interview.Time_Complexity.AmortizedTime;

/**
 * Created by liuyubobobo.
 */
public class MyVector<Item> {//使用jdk自带的静态数组实现动态数组
    ...
    // 平均复杂度为 O(1)
    public void push_back(Item e){//添加元素
