package _courses.imooc.algorithmic_interview.Array.LongestSubstringWithoutRepeatingCharacters;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Test: 100,000 length of completely random string:");
